...
```javascript
let array1 = [1, 2, 3];
let array2 = array1.map(x => x * 2); // [2, 4, 6]
```

### [`array.reduce()`](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce) / [`array.reduceRight()`](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Global_Objects/Array/ReduceRight)

_Run a given function on each item regarding the previous result_
